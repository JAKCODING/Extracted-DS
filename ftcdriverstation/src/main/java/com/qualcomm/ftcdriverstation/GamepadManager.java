...
public class GamepadManager implements RobotCoreGamepadManager, InputManager.InputDeviceListener {
            ...
            if (var3 != null) {
                ...
                if (var3 != null) {
                    try {
                        ...
                        RobotLog.vv("GamepadManager", "Input device %d has been autodetected based on USB VID and PID as %s", new Object[]{var2.getId(), var3.getClass().getSimpleName()});
                ...
                if (var3 != null) {
                    try {
                        ...
                        var3.setVidPid(var2.getVendorId(), var2.getProductId());
                        this.gamepadIdToGamepadMap.put(var2.getId(), var3);
                        RobotLog.vv("GamepadManager", "Input device %d has a USB VID and PID that has an entry in override list; treating as %s", new Object[]{var2.getId(), var3.getClass().getSimpleName()});
                ...
                Gamepad var160;
                com.qualcomm.ftcdriverstation.GamepadManager.GamepadUserPointer var162;
                try {
                    var162 = new com.qualcomm.ftcdriverstation.GamepadManager.GamepadUserPointer(this);
                ...
                if (var160 != null) {
                    try {
                        ...
                        RobotLog.vv("GamepadManager", "Using quantum superposition to guess that input device %d should be treated as %s", new Object[]{var2.getId(), var160.getClass().getSimpleName()});
    ...
    public void onAssignedGamepadDropped(Gamepad gamepad) {
        ...
        Toast.makeText(this.context, String.format("Gamepad %d connection lost", new Object[]{Byte.valueOf(gamepad.getUser().id)}), 0).show();
    ...
    public void automagicallyReassignIfPossible(InputDevice inputDevice, RemovedGamepadMemory removedGamepadMemory) {
        ...
        if (removedGamepadMemory.memoriesAmbiguousIfBothPositionsEmpty() && this.userToGamepadIdMap.isEmpty()) {
            ...
            Toast.makeText(this.context, String.format("Gamepad %d auto-recovered", new Object[]{Byte.valueOf(removedGamepadMemory.user.id)}), 0).show();
        }
    }
}
