...
public class GamepadTypeOverrideMapper {
    ...
    static class GamepadTypeOverrideEntry {
        ...
        public Gamepad createGamepad() {
            int i = AnonymousClass1.$SwitchMap$com$qualcomm$robotcore$hardware$Gamepad$Type[this.mappedType.ordinal()];
            if (i == 1) {
    ...
    /* renamed from: com.qualcomm.ftcdriverstation.GamepadTypeOverrideMapper$1  reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                com.qualcomm.robotcore.hardware.Gamepad$Type r1 = com.qualcomm.robotcore.hardware.Gamepad.Type.LOGITECH_F310     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$com$qualcomm$robotcore$hardware$Gamepad$Type     // Catch:{ NoSuchFieldError -> 0x001d }
                com.qualcomm.robotcore.hardware.Gamepad$Type r1 = com.qualcomm.robotcore.hardware.Gamepad.Type.XBOX_360     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$com$qualcomm$robotcore$hardware$Gamepad$Type     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.qualcomm.robotcore.hardware.Gamepad$Type r1 = com.qualcomm.robotcore.hardware.Gamepad.Type.SONY_PS4     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.qualcomm.ftcdriverstation.GamepadTypeOverrideMapper.AnonymousClass1.<clinit>():void");
        }
    }
