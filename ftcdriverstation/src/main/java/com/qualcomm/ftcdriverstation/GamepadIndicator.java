...
public class GamepadIndicator {
    ...
    public void setState(final State state2) {
        ...
        AppUtil.getInstance().runOnUiThread(new Runnable() {
            public void run() {
                int i = AnonymousClass3.$SwitchMap$com$qualcomm$ftcdriverstation$GamepadIndicator$State[state2.ordinal()];
                if (i == 1) {
    ...
    static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.qualcomm.ftcdriverstation.GamepadIndicator.AnonymousClass3.<clinit>():void");
        }
    }
